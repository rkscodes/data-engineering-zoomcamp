...
def main(params):
    ...
    fragement = re.search("csv.gz$", csv_name)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        "Description: Arguments parsers for data ingesting"
    )
    ...
    parser.add_argument(
        "--host", required=True, help="address where postgress is hosted"
    )
    parser.add_argument(
        "--port", required=True, help="port at which postgress is running"
    )
